...
namespace Hp2BaseModTweaks
{
    ...
    public static class AllowSpecialDollsPatch
    {
        private static void Postfix(UiDoll __instance)
        {
            ...
            var specialEffectAccess = AccessTools.Field(typeof(UiDoll), "_specialEffect");

            if (specialEffectAccess.GetValue(__instance) as UiDollSpecialEffect == null
                && __instance.soulGirlDefinition?.specialEffectPrefab != null)
            {
                ...
                specialEffectAccess.SetValue(__instance, specialEffectInstance);
